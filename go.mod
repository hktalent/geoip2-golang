module github.com/hktalent/geoip2-golang

go 1.19

require (
	github.com/hktalent/go-utils v0.0.0-20230303035343-876e9ba3b8d6
...
require (
	...
	github.com/hktalent/PipelineHttp v0.0.0-20230218041433-381be673770a // indirect
